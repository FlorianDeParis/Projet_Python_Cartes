...
# Base de données: magic_carte
# Temps de génération: 2014-07-09 14:35:40 +0000
# ************************************************************
...
# Affichage de la table APPARTIEN
# ------------------------------------------------------------
...
# Affichage de la table APPORT_MANA
# ------------------------------------------------------------
...
/*!40000 ALTER TABLE `APPORT_MANA` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `APPORT_MANA` ENABLE KEYS */;
UNLOCK TABLES;


# Affichage de la table CARTE
# ------------------------------------------------------------
...
# Affichage de la table COUT_INVOQUE
# ------------------------------------------------------------
...
/*!40000 ALTER TABLE `COUT_INVOQUE` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `COUT_INVOQUE` ENABLE KEYS */;
UNLOCK TABLES;


# Affichage de la table DECK
# ------------------------------------------------------------
...
/*!40000 ALTER TABLE `LIE` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `LIE` ENABLE KEYS */;
UNLOCK TABLES;


# Affichage de la table PERSO
# ------------------------------------------------------------
